...
export const apartments = pgTable("apartments", {
  ...
  hotresTypeId: integer("hotres_type_id"),
  hotresRateId: integer("hotres_rate_id"),
});
...
export const dailyPrices = pgTable("daily_prices", {
  ...
  pricePerPerson1: decimal("price_per_person_1", { precision: 10, scale: 2 }),
  pricePerPerson2: decimal("price_per_person_2", { precision: 10, scale: 2 }),
  pricePerPerson3: decimal("price_per_person_3", { precision: 10, scale: 2 }),
  pricePerPerson4: decimal("price_per_person_4", { precision: 10, scale: 2 }),
  pricePerPerson5: decimal("price_per_person_5", { precision: 10, scale: 2 }),
  pricePerPerson6: decimal("price_per_person_6", { precision: 10, scale: 2 }),
  pricePerPerson7: decimal("price_per_person_7", { precision: 10, scale: 2 }),
  pricePerPerson8: decimal("price_per_person_8", { precision: 10, scale: 2 }),
  childPrice1: decimal("child_price_1", { precision: 10, scale: 2 }),
  childPrice2: decimal("child_price_2", { precision: 10, scale: 2 }),
  childPrice3: decimal("child_price_3", { precision: 10, scale: 2 }),
  currency: text("currency").default("PLN"),
