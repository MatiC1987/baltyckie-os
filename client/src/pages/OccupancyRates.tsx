          ...
          <div className="grid gap-2 sm:gap-3 grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardContent className="pt-4 pb-3">
                ...
                <p className="text-lg sm:text-xl font-bold mt-1">{data.apartments.length}</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-4 pb-3">
                <p className="text-xs text-muted-foreground font-medium">Średnie obłożenie</p>
                <p className={`text-lg sm:text-xl font-bold mt-1 ${getRateColor(data.overall.rate)}`}>{data.overall.rate}%</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-4 pb-3">
                <p className="text-xs text-muted-foreground font-medium">Dni zajęte</p>
                <p className="text-lg sm:text-xl font-bold mt-1">{data.overall.occupiedDays} / {data.overall.totalDays}</p>
              </CardContent>
            </Card>
          </div>
