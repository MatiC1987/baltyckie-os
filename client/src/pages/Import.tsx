        ...
        <div className="border rounded-lg p-4 space-y-3 border-amber-300 bg-amber-50/50 dark:border-amber-700 dark:bg-amber-950/20">
          <div className="flex items-start gap-2">
            ...
            <div className="space-y-1 flex-1">
              <p className="text-sm font-semibold text-amber-800 dark:text-amber-300">Deep Sync — naprawa 300 ostatnich rezerwacji z HotRes API</p>
              <p className="text-xs text-amber-700 dark:text-amber-400">
                Pobiera <strong>300 najnowiej zmodyfikowanych</strong> rezerwacji z HotRes API i nadpisuje kwoty zgodnie z aktualną logiką (total + addons_amount). API HotRes nie obsługuje paginacji — limit 300 jest techniczny i nie do obejścia. Dla naprawy cen <strong>wszystkich</strong> rezerwacji historycznych użyj <em>Napraw ceny (fallback)</em> poniżej.
              </p>
            </div>
          </div>
          <Button
