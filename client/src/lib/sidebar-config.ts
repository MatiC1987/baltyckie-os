...
export const DEFAULT_SECTIONS: NavSection[] = [
  ...
  { id: "cennik", title: "CENNIK", itemIds: ["price-calendar", "pricing-rules", "pricing-analytics"], color: "yellow" },
...
const STORAGE_KEY = "sidebar-config-v20";
