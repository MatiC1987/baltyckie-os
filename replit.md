...
- 2026-02-18: Added Document Templates system - document_categories table (name, sortOrder), document_templates table (name, categoryId FK, fileName, objectPath, description). Full CRUD API with Zod validation. DocumentTemplates page (/document-templates) with category management (add/edit/delete), document upload via Object Storage, download links, search, category filter, sortable columns. DOKUMENTY section in sidebar between DANE and USTAWIENIA.
