...
-   **Financial Management**: Dashboard overview, detailed expense tracking, bank account management, balance snapshots, and owner payments. Includes comprehensive forecasting (revenue, apartment costs, operational costs) with spreadsheet-like editing, historical trends, and year-over-year comparisons. An enhanced financial analysis module (FINANSE v2) provides deeper insights into revenue, costs, and plan vs. actual deviations.
